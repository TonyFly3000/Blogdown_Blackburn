...
Tensorflow in R 系列(7) :图片分类 Cats dog image classification with Tansfer learning

Tensorflow in R 系列(8) :图片分类 Cats dog image classification with Google vision API
