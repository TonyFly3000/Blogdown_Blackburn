...
vector is 1 dimension elements.

vector can only have one data type. For example all number or all character.
...
## Array002 is 4 * 3 * 2  **character** type and **Array** structure
...
It can be called as dataset sometimes.It can have different data type.
