...
# first time download data run following:
# dataset, metadata = tfds.load('fashion_mnist',as_supervised=True, with_info=True)


dataset, metadata = tfds.load('fashion_mnist',  data_dir='C:/Users/tduan/tensorflow_datasets',as_supervised=True, with_info=True)
