...
# check which mirror is the fastest to download from
...
# download one package with fastest mirror
...
# set fastest mirror for all package download 
...
# one click update all R package
